...
The ephemeride calculation for the planets, comets and numerical integration is based on source code which is
copyright (C) 1998 by Springer-Nature, Berlin Heidelberg and originates the code described in the book 
Astronomy on the Personal Computer, ISBN 3-540-63521-1 3rd edition 1998.  Authors Oliver Montenbruck and Thomas Pleger.
...
The units using this code are marked as such in the header.
